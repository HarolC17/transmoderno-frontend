...
function DashboardHome() {
    ...
    const cards = [
        {label: 'Participantes registrados', valor: stats.participantes, color: 'bg-green-50 border-green-100', texto: 'text-green-700', icono: '👥'},
        {label: 'Sesiones creadas', valor: stats.sesiones, color: 'bg-blue-50 border-blue-100', texto: 'text-blue-700', icono: '📅'},
        {label: 'Solicitudes pendientes', valor: stats.solicitudesPendientes, color: 'bg-red-50 border-red-100', texto: 'text-red-700', icono: '🙋'},
    ]
                ...
                <div className="bg-white rounded-2xl border border-gray-100 p-5">
                    ...
                    <div className="flex flex-col gap-3">
                        <div className="flex items-center gap-3 p-3 bg-green-50 rounded-xl">
                            <div className="w-8 h-8 rounded-full bg-green-700 flex items-center justify-center text-white text-xs font-bold">1</div>
                            <div>
                        ...
                        <div className="flex items-center gap-3 p-3 bg-green-50 rounded-xl">
                            <div className="w-8 h-8 rounded-full bg-green-700 flex items-center justify-center text-white text-xs font-bold">2</div>
                            <div>
